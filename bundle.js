...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2['default'].render(_react2['default'].createElement(App), document.getElementById('main'));
		...
		render: function render() {
			...
			return _react2['default'].createElement(
				...
				_react2['default'].createElement(
					...
					answered ? answeredCorrect ? 'Correct: ' + question.explanation : explanation : null
				)
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DATA_URL = 'questions.v2.json';
	...
	exports.reset = reset;
	var markCorrect = function markCorrect(_ref) {
		var questions = _ref.questions;

		console.log(Object.keys((0, _save.load)()));
		(0, _save.save)(Object.assign((0, _save.load)(), _defineProperty({}, questions[0].id, true)));
		return { questions: questions.slice(1) };
	};

	exports.markCorrect = markCorrect;
	var markWrong = function markWrong(_ref2) {
